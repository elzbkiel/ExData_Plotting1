plot3 <- function() {
    ...
    ## Plot Energy Sub Metering 1, 2, 3 in function of the day name
    plot.new()   ## reset par()
    png("plot3.png", width = 480, height = 480)  ## px is the default unit
    ...
    return(paste("See plot3.png in ", getwd()))
